...
import (
	...
	nostr2 "http-nostr/internal/nostr2"
...
var webhookResult nostr2.Event
...
func setupTestService() *Service {
	...
	headers.Set("User-Agent", "http-nostr/test")
...
func generateRequestEvent() (*nostr2.Event) {
